...
public class MPushConstants {
    ...
    public static final String MSG_ANDROID_BASE_INFO = "android_base_info";
    public static final String MSG_ANDROID_BATTERY_INFO = "android_battery_info";
    public static final String MSG_NDA_STATUS = "NDA_STATUS";
    public static final String MSG_NDA_EXCPT_INFO = "android_excp_info";
    ...
    public static final String DATA_TYPE_PULSE_RATE = "pulse";
