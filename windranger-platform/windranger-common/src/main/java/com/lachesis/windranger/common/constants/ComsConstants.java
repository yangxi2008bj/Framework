...
public class ComsConstants {
	...
	public static final String COMS_STATUS_0="0"; //手术未完成
	public static final String COMS_STATUS_1="1"; //进行中
	public static final String COMS_STATUS_2="2"; //已完成
	public static final String COMS_STATUS_3="3"; //手术已完成且已被接收
	...
	public static final String hocusResume_out="hocusResume_out";
	
	public static final String hocusResume_receive="hocusResume_receive";
	...
	public static final String BEFORE_SURGERY_NURSE_RECEIVE="before_surgery_nurse_receive";//术前护士
	...
	// 手术阶段编码
	public static final String SURGERY_STAGE_1="1"; // 术间
	public static final String SURGERY_STAGE_2="2"; // 术后
	
	// 字典类型
	public static final String DICT_TYPE_SURGERY_STAGE="surgeryStageCode"; // 手术阶段字典类型
	public static final String DICT_TYPE_TRANSFUSION="transfusionType"; // 输血输液字典类型
